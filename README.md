...
| TC-SQLi 02 | Input `' UNION SELECT username, password, null FROM users --` di field search bar kelola rekening | tidak ada data yang ditampilkan dalam list rekening | tidak ada data yang ditampilkan dalam list rekening | PASS | ![TC-SQLi-03](image-33.png) |
